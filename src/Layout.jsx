...
const AppLayout = ({ children }) => {
  ...
  const mainNavigation = useMemo(() => [
    ...
    { title: "Resumos", url: createPageUrl("ResumosPersonalizados"), icon: BarChart3, allowedLevels: ['admin', 'gestor_contrato', 'sala_tecnica_afirmaevias'] },
            ...
            <header className="bg-white/10 backdrop-blur-lg border-b border-white/10 px-6 py-4 md:hidden">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <SidebarTrigger className="bg-[#00233B] hover:bg-[#00233B]/90 p-3 rounded-lg transition-colors duration-200 [&>svg]:ring-2 [&>svg]:ring-[#BFCF99] [&>svg]:rounded [&>svg]:w-7 [&>svg]:h-7" />
...
export default function Layout({ children, currentPageName }) {
  const reportPages = useMemo(() => ["RelatorioEnsaio", "RelatorioDiario", "RelatorioChecklist", "RelatorioChecklistAplicacao", "RelatorioChecklistMRAF", "RelatorioChecklistConcretagem", "RelatorioChecklistTerraplanagem", "RelatorioChecklistReciclagem", "RelatorioSondagem", "RelatorioDensidadeInSitu", "RelatorioTaxaPinturaImprimacao", "RelatorioConsolidado", "RelatorioCAUQ", "RelatorioGranulometriaIndividual", "RelatorioAcompanhamentoUsinagem"], []);
