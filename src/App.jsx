  ...
  return (
    <Routes>
      ...
      <Route
        path="/EnsaioProctor"
        element={
          <LayoutWrapper currentPageName="EnsaioProctor">
            <EnsaioProctor />
          </LayoutWrapper>
        }
      />
      <Route
        path="/RelatorioProctor"
        element={
          <LayoutWrapper currentPageName="RelatorioProctor">
            <RelatorioProctor />
          </LayoutWrapper>
        }
      />
      <Route
        path="/EnsaioRompimentoConcreto"
        element={
      ...
      />
      <Route
        path="/RelatorioUnificado"
        element={
          <LayoutWrapper currentPageName="RelatorioUnificado">
            <RelatorioUnificado />
          </LayoutWrapper>
        }
      />
