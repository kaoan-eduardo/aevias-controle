    ...
    <div className="bg-white min-h-screen">
      ...
      <div>
        <div className="w-full max-w-[270mm] mx-auto bg-white shadow-xl print:shadow-none pt-0.5 px-3 pb-0.5 print:pt-0 print:px-0.5 print:pb-0">
          ...
          <footer className={`px-1.5 print:break-inside-avoid print:px-0.5 ${ensaio.realizar_marshall || ensaio.realizar_densidade_rice ? 'mt-0 print:mt-0' : 'mt-32 print:mt-24'}`}>
