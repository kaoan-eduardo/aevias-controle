      ...
      <div>
        <div className="w-full max-w-[270mm] mx-auto bg-white shadow-xl print:shadow-none pt-0.5 px-3 pb-0.5 print:pt-0 print:px-0.5 print:pb-0">
          ...
          <main className="text-sm print:text-sm">
            ...
            {/* Observações */}
            {!ensaio.realizar_marshall && !ensaio.realizar_densidade_rice && (
              <div className="mt-0 print:mt-0 print:mb-auto">
                <div className="bg-slate-200 font-bold px-2 py-1 text-[10px] print:text-[8px] print:py-1">OBSERVAÇÕES</div>
                <div className="border border-slate-300 p-2 text-[10px] h-[60px] print:text-[8px] print:p-1 print:h-[30px] overflow-hidden">
                  {ensaio.observacoes || ''}
                </div>
              </div>
            )}
          ...
          <footer className={`px-1.5 print:break-inside-avoid print:px-0.5 ${ensaio.realizar_marshall ? 'mt-0 print:mt-0' : 'mt-[250px]'}`}>
