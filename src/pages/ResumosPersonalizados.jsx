...
const CAMPOS_POR_TIPO = {
  ...
  ChecklistUsina: [
    ...
    { key: "controle_cauq", label: "Controle CAUQ", subfields: [
      ...
      { key: "teor_ligante_quantidade", label: "Qtd. Teor Ligante" },
      { key: "teor_ligante_conforme", label: "Teor Ligante Conforme" },
      { key: "densidade_aparente", label: "Densidade Aparente (g/cm³)" },
      { key: "densidade_aparente_quantidade", label: "Qtd. Densidade Aparente" },
      { key: "densidade_aparente_conforme", label: "Densidade Aparente Conforme" },
      { key: "volume_vazios", label: "Volume Vazios (%)" },
      { key: "volume_vazios_quantidade", label: "Qtd. Volume Vazios" },
      { key: "volume_vazios_conforme", label: "Volume Vazios Conforme" },
      { key: "vam", label: "VAM (%)" },
      { key: "vam_quantidade", label: "Qtd. VAM" },
      { key: "vam_conforme", label: "VAM Conforme" },
      { key: "rbv", label: "RBV (%)" },
      { key: "rbv_quantidade", label: "Qtd. RBV" },
      { key: "rbv_conforme", label: "RBV Conforme" },
      { key: "rtcd", label: "RTCD (MPa)" },
      { key: "rtcd_quantidade", label: "Qtd. RTCD" },
      { key: "rtcd_conforme", label: "RTCD Conforme" },
      { key: "estabilidade", label: "Estabilidade (Kgf)" },
      { key: "estabilidade_quantidade", label: "Qtd. Estabilidade" },
      { key: "estabilidade_conforme", label: "Estabilidade Conforme" },
      { key: "fluencia", label: "Fluência (mm)" },
      { key: "fluencia_quantidade", label: "Qtd. Fluência" },
      { key: "fluencia_conforme", label: "Fluência Conforme" }
    ]},
