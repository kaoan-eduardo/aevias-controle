...
const CAMPOS_POR_TIPO = {
  ...
  ChecklistAplicacao: [
    ...
    { key: "fresagem_preparacao.destinacao_material", label: "Destinação Material Fresado" },
    { key: "fresagem_preparacao.remocao_material_solto", label: "Remoção Material Solto" },
    { key: "fresagem_preparacao.pavimento_condicoes", label: "Pavimento em Condições para Pintura" },
    ...
    { key: "pintura_ligacao.taxa_pintura.resultado", label: "Taxa de Pintura" },
    ...
    { key: "pintura_ligacao.residuo_emulsao.conforme", label: "Resíduo da Emulsão Conforme" },
    { key: "pintura_ligacao.taxa_pintura_residual.resultado", label: "Taxa de Pintura Residual" },
    { key: "pintura_ligacao.taxa_pintura_residual.conforme", label: "Taxa de Pintura Residual Conforme" },
    { key: "controle_aplicacao.temperatura_aplicacao", label: "Temp. Aplicação das Cargas (°C)" },
    { key: "controle_aplicacao.espessura_camada", label: "Espessura da Camada (cm)" },
    { key: "approved", label: "Status Aprovação" }
  ],
  ChecklistMRAF: [
    { key: "data", label: "Data" },
