...
export default function Dashboard() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const loadPromises = [
        base44.entities.Obra.list("-created_date", 5000),
        base44.entities.Project.list("-created_date", 5000),
        base44.entities.EnsaioCAUQ.list("-created_date", 5000),
        base44.entities.EnsaioDensidade.list("-created_date", 5000),
        base44.entities.DiarioObra.list("-created_date", 5000),
        base44.entities.ChecklistUsina.list("-created_date", 5000),
        base44.entities.ChecklistAplicacao.list("-created_date", 5000),
        base44.entities.ChecklistMRAF.list("-created_date", 5000),
        base44.entities.ChecklistConcretagem.list("-created_date", 5000),
        base44.entities.ChecklistTerraplanagem.list("-created_date", 5000),
        base44.entities.ChecklistReciclagem.list("-created_date", 5000),
        base44.entities.EnsaioMRAF.list("-created_date", 5000),
        base44.entities.EnsaioDensidadeInSitu.list("-created_date", 5000),
        base44.entities.EnsaioTaxaPinturaImprimacao.list("-created_date", 5000),
        base44.entities.EnsaioSondagem.list("-created_date", 5000),
        base44.entities.EnsaioGranulometriaIndividual.list("-created_date", 5000),
        base44.entities.AcompanhamentoUsinagem.list("-created_date", 5000),
        base44.entities.AcompanhamentoCarga.list("-created_date", 5000),
        base44.entities.EnsaioManchaPendulo.list("-created_date", 5000),
        base44.entities.EnsaioVigaBenkelman.list("-created_date", 5000),
      ];
