  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="w-full max-w-[210mm] mx-auto bg-white py-3 px-4 print:py-2 print:px-3">
        ...
        {/* Dados da Obra */}
        <div className="mb-2">
          <div className="bg-slate-100 text-center text-xs font-bold py-0.5 mb-1 uppercase tracking-wider">Dados da Obra</div>
        ...
        {/* Dados do Ensaio */}
        <div className="mb-2">
          <div className="bg-slate-100 text-center text-xs font-bold py-0.5 mb-1 uppercase tracking-wider">Dados do Ensaio</div>

          {/* Área da Bandeja */}
          <div className="bg-slate-50 text-center text-xs font-semibold py-0.5 mb-1">Área da Bandeja</div>
          ...
          {/* Execução do Ensaio */}
          <div className="bg-slate-50 text-center text-xs font-semibold py-0.5 mb-1">Execução do Ensaio</div>
          <table className="w-full border-collapse border border-slate-300 text-xs mb-2">
            <thead className="bg-slate-50">
              <tr>
                <th className="border border-slate-300 px-2 py-1 text-left font-medium">Grandeza</th>
