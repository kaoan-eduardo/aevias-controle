                    ...
                    <tr key={ensaio.id} className={`border-b border-white/10 hover:bg-black/5 ${index % 2 === 0 ? 'bg-transparent' : 'bg-black/[0.02]'}`}>
                       <td className="px-2 py-2">
                        ...
                        <div className="text-[#00233B]/50 text-center text-xs">-</div>
                          ...
                          <Badge className="bg-blue-100/80 text-[10px] px-2 py-1 font-semibold rounded-md inline-flex items-center focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow border border-blue-300/50 hover:bg-blue-200/80 hover:border-blue-400/50 transition-colors gap-1">
