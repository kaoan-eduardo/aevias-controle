...
const SectionTitle = ({ children }) => (
  <h2 className="text-xs font-bold text-center bg-slate-100 py-1 px-1 my-1 uppercase tracking-wide">{children}</h2>
);
...
const ReportPrintHeader = ({ checklist, obra, regional, project }) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-x-2 gap-y-1 mb-2 text-xs">
        <div>
...
const ReportFooter = ({ checklist, pageNum, totalPages }) => {
  ...
  return (
    <footer className="mt-4 px-4 print:break-inside-avoid">
  ...
  return (
    <>
      ...
      <div className="break-after-page">
            ...
            <tbody>
              ...
              <tr>
                <td className="border border-slate-300 px-2 py-1 bg-white">
                  ...
                  <div className="flex gap-1 mt-1 ml-1" style={{ fontSize: '7px' }}>
          ...
          <table className="w-full border-collapse border border-slate-300 text-[10px]">
            <thead>
              <tr className="bg-white">
                ...
                <th className="border border-slate-300 px-2 py-1 text-center font-medium w-14">Sim</th>
                <th className="border border-slate-300 px-2 py-1 text-center font-medium w-14">Não</th>
                <th className="border border-slate-300 px-2 py-1 text-center font-medium w-14">Qtde</th>
            ...
            <tbody>
              {[
                ...
                return (
                  <tr key={ensaio.key}>
                    <td className="border border-slate-300 px-2 py-1 bg-white text-xs">{ensaio.label}</td>
                    ...
                    <td className="border border-slate-300 px-2 py-1 text-center text-xs">{dados.quantidade || '-'}</td>
                    <td className="border border-slate-300 px-2 py-1 text-center">
                    ...
                    <td className="border border-slate-300 px-2 py-1 text-xs font-medium text-center">{dados.resultados || '-'}</td>
                    <td className="border border-slate-300 px-2 py-1 text-xs">{dados.observacoes || '-'}</td>
                  </tr>
                );
              })}
            </tbody>
        ...
        <div className="border border-slate-300 p-2 min-h-[60px] text-xs mb-2">
