    ...
    <>
      ...
      {photoChunks.map((chunk, pageIndex) => (
        <div key={pageIndex} className="break-after-page">
          ...
          <main className="grid grid-cols-2 gap-2 flex-grow mb-1">
            {chunk.map((fotoUrl, fotoIndex) => (
              <div key={fotoIndex} className="border border-slate-300 p-1 rounded-lg break-inside-avoid flex flex-col">
                <div className="bg-gray-100 flex items-center justify-center rounded overflow-hidden flex-grow" style={{ minHeight: '280px' }}>
