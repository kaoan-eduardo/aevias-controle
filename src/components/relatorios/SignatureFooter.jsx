    ...
    <div className="grid grid-cols-3 gap-0.5 items-end print:gap-0.5">
      ...
      <div className="text-center">
        <div className={`${textSize} text-slate-500 mb-0 ${minHeight} flex flex-col justify-end items-center print:mb-0`}>
          {labName && (
            <>
              <p className="font-bold text-slate-600">{labName}</p>
      ...
      <div className="text-center">
        {approverEmail ? (
          <>
            <div className={`${textSize} text-slate-500 mb-0 ${minHeight} flex flex-col justify-end items-center print:mb-0`}>
              {approverName && <p className="font-bold text-slate-600">{approverName}</p>}
      ...
      <div className="text-center">
        {clientEmail ? (
          <>
            <div className={`${textSize} text-slate-500 mb-0 ${minHeight} flex flex-col justify-end items-center print:mb-0`}>
              {clientName && <p className="font-bold text-slate-600">{clientName}</p>}
