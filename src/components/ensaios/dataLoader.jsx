...
export const loadAllData = async () => {
  ...
  const [
    ...
    ChecklistUsina.list("-created_date", 5000),
    ChecklistAplicacao.list("-created_date", 5000),
    ChecklistMRAF.list("-created_date", 5000),
    ChecklistConcretagem.list("-created_date", 5000),
    ...
    base44.entities.EnsaioTaxaMRAF.list("-created_date", 5000),
