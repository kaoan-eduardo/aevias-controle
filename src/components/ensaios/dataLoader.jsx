...
export const loadAllData = async () => {
  ...
  const [
    ...
    loadWithFallback(() => DiarioObra.list("-created_date", 500), "DiarioObra", []),
    loadWithFallback(() => base44.entities.EnsaioCAUQ.list("-created_date", 500), "EnsaioCAUQ", []),
    loadWithFallback(() => base44.entities.EnsaioMRAF.list("-created_date", 500), "EnsaioMRAF", []),
    loadWithFallback(() => EnsaioDensidade.list("-created_date", 500), "EnsaioDensidade", []),
    loadWithFallback(() => base44.entities.EnsaioDensidadeInSitu.list("-created_date", 500), "EnsaioDensidadeInSitu", []),
    loadWithFallback(() => base44.entities.EnsaioTaxaPinturaImprimacao.list("-created_date", 500), "EnsaioTaxaPinturaImprimacao", []),
    loadWithFallback(() => ChecklistUsina.list("-created_date", 500), "ChecklistUsina", []),
    loadWithFallback(() => ChecklistAplicacao.list("-created_date", 500), "ChecklistAplicacao", []),
    loadWithFallback(() => ChecklistMRAF.list("-created_date", 500), "ChecklistMRAF", []),
    loadWithFallback(() => ChecklistConcretagem.list("-created_date", 500), "ChecklistConcretagem", []),
    loadWithFallback(() => base44.entities.ChecklistTerraplanagem.list("-created_date", 500), "ChecklistTerraplanagem", []),
    loadWithFallback(() => base44.entities.ChecklistReciclagem.list("-created_date", 500), "ChecklistReciclagem", []),
    loadWithFallback(() => base44.entities.EnsaioSondagem.list("-created_date", 500), "EnsaioSondagem", []),
    loadWithFallback(() => base44.entities.EnsaioGranulometriaIndividual.list("-created_date", 500), "EnsaioGranulometriaIndividual", []),
    loadWithFallback(() => base44.entities.AcompanhamentoUsinagem.list("-created_date", 500), "AcompanhamentoUsinagem", []),
    loadWithFallback(() => base44.entities.AcompanhamentoCarga.list("-created_date", 500), "AcompanhamentoCarga", []),
    loadWithFallback(() => base44.entities.EnsaioManchaPendulo.list("-created_date", 500), "EnsaioManchaPendulo", []),
    loadWithFallback(() => base44.entities.EnsaioVigaBenkelman.list("-created_date", 500), "EnsaioVigaBenkelman", []),
    loadWithFallback(() => base44.entities.EnsaioTaxaMRAF.list("-created_date", 500), "EnsaioTaxaMRAF", []),
    loadWithFallback(() => base44.entities.BoletimSondagem.list("-created_date", 500), "BoletimSondagem", []),
    loadWithFallback(() => base44.entities.BoletimSondagemTrado.list("-created_date", 500), "BoletimSondagemTrado", []),
    loadWithFallback(() => base44.entities.EnsaioProctor.list("-created_date", 500), "EnsaioProctor", []),
    loadWithFallback(() => base44.entities.EnsaioRompimentoConcreto.list("-created_date", 500), "EnsaioRompimentoConcreto", []),
    loadWithFallback(() => base44.entities.GranuMistura.list("-created_date", 500), "GranuMistura", [])
  ]);
